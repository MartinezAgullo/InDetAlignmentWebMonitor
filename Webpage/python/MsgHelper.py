...
class msgServer:
    ...
    #  printList
    # =================================================================================
    def printList(self, mylist, debugLevel):
        for item in mylist:
            if debugLevel == 0: self.printDebug(item)
            elif debugLevel == 1: self.printInfo(item)
            elif debugLevel == 2: self.printWarning(item)
            elif debugLevel == 3: self.printError(item)
            elif debugLevel == 4: self.printFatal(item)

    # =================================================================================
    #  printDict
    # =================================================================================
    def printDict(self, mydict):
        for item in sorted(mydict): print item+': '+str(mydict[item])
        print

    # =================================================================================
    #  getDebugLevel
    # =================================================================================
    def getDebugLevel(self): return self.debugLevel
